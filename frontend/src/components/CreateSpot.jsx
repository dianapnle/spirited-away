...
const CreateSpotForm = () => {
    ...
    useEffect(() => {
        ...
        if (description && description.length < 30) errors.description = 'Description needs a minimum length of 30 characters';
        ...
        <section className="form-container">
          <form className="create-spots-form" onSubmit={handleSubmit}>
            ...
            <label>
                ...
                Country {hasSubmitted=== true && errors.country && <p className="errors">{errors.country}</p>}
            <br></br>
            <input
              type="country"
              class="input-box"
            ...
            <label>
                Street Address {hasSubmitted=== true && errors.address && <p className="errors">{errors.address}</p>}
            <br></br>
            <input
              type="address"
              class="input-box"
              ...
              <br></br>
            <label>
                City {hasSubmitted=== true && errors.city && <p className="errors">{errors.city}</p>}
            <br></br>
            <input
              type="city"
              class="input-box"
              ...
              <label>
                State
                {hasSubmitted=== true && errors.state && <p className="errors">{errors.state}</p>}
            <br></br>
            <input
              type="city"
              class="input-box"
            ...
            <label>
                Latitude
                {hasSubmitted=== true && errors.latitude && <p className="errors">{errors.latitude}</p>}
            <br></br>
            <input
              type="latitude"
              class="input-box"
            ...
            <label>
                Longitude
                {hasSubmitted=== true && errors.longitude && <p className="errors">{errors.longitude}</p>}
            <br></br>
            <input
              type="longitude"
              class="input-box"
